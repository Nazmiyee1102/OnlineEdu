...
namespace OnlineEdu.WebUI.Areas.Admin.Controllers
{
    ...
    public class SocialMediaController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateSocialMedia(UpdateSocialMediaDto updateSocialMediatDto)
        {
            await _client.PutAsJsonAsync("SocialMedias", updateSocialMediatDto);
            return RedirectToAction("Index");
        }
    }
}
