...
namespace OnlineEdu.WebUI.Areas.Teacher.Controllers
{
    ...
    public class MySocialMediaController: Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateTeacherSocial(UpdateTeacherSocialDto updateTeacherSocialtDto)
        {
            await _client.PutAsJsonAsync("teacherSocials", updateTeacherSocialtDto);
            return RedirectToAction("Index");
        }
    }
}
